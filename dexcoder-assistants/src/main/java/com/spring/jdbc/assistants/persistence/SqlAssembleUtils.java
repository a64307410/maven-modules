...
import com.spring.jdbc.assistants.exceptions.AssistantException;
...
public class SqlAssembleUtils {
    ...
    public static BoundSql buildInsertSql(Object entity, Criteria criteria, NameHandler nameHandler) {
        ...
        List< AutoField > autoFields = criteria.getAutoFields();
        ...
        for (AutoField autoField : autoFields) {
            ...
            //白名单 黑名单
            if (!CollectionUtils.isEmpty(criteria.getIncludeFields()) && !criteria.getIncludeFields().contains( autoField.getName())) {
                continue;
            } else if (!CollectionUtils.isEmpty(criteria.getExcludeFields()) && criteria.getExcludeFields().contains( autoField.getName())) {
                continue;
            }
    ...
    public static BoundSql buildUpdateSql(Object entity, Criteria criteria, NameHandler nameHandler) {
        ...
        while (iterator.hasNext()) {
            ...
            sql.append("`").append(columnName).append("` ").append(autoField.getFieldOperator()).append(" ");
    ...
    private static BoundSql builderWhereSql(List<AutoField> autoFields, NameHandler nameHandler) {
        ...
        while (iterator.hasNext()) {
            ...
            String columnName = "`".concat(nameHandler.getColumnName(autoField.getName())).concat("`");
            Object[] values = autoField.getValues();
     ...
     * @return
     */
    public static BoundSql buildDeleteSql( Class< ? > clazz, NameHandler nameHandler, Object id ) {
     ...
     * @return bound sql
     */
    public static BoundSql buildByIdSql(Class<?> clazz, Object id, Criteria criteria,
                                        NameHandler nameHandler) {
        criteria = criteria == null ? Criteria.create( clazz ) : criteria;
        Class<?> entityClass = (clazz == null ? criteria.getEntityClass() : clazz);
        String tableName = nameHandler.getTableName( entityClass );
        String primaryName = nameHandler.getPKName( entityClass );
        String columns = SqlAssembleUtils.buildColumnSql( entityClass, nameHandler,criteria.getIncludeFields(), criteria.getExcludeFields() );
    ...
    public static BoundSql buildQuerySql(Object entity, Criteria criteria, NameHandler nameHandler) {
        ...
        querySql.append("`").append(tableName).append("`");
     ...
     * @return
     */
    public static BoundSql buildWhereOrderSql(Object entity, Criteria criteria, NameHandler nameHandler) {
    ...
    public static BoundSql buildCountSql(Object entity, Criteria criteria, NameHandler nameHandler) {
        ...
        countSql.append("`").append(tableName).append("`");
    ...
    public static String buildColumnSql(Class<?> clazz, NameHandler nameHandler,
        ...
        for (PropertyDescriptor pd : pds) {
            ...
            String columnName = "`".concat(nameHandler.getColumnName(fieldName)).concat("`,");
    ...
    public static String buildOrderBy(String sort, NameHandler nameHandler, String... properties) {
        ...
        for (String property : properties) {
            String columnName = "`".concat(nameHandler.getColumnName(property)).concat("`");
