 ...
 * 
 */
public class InsertSelectiveGetKeyElementGenerator extends
        AbstractXmlElementGenerator {

    public InsertSelectiveGetKeyElementGenerator() {
        super();
    }
    ...
    public void addElements(XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute(
                "id", introspectedTable.getInsertSelectiveGetKeyStatementId())); //$NON-NLS-1$
        ...
        for (IntrospectedColumn introspectedColumn : introspectedTable.getAllColumns()) {
            if (introspectedColumn.isPrimaryKey()) primaryKeyColumn = introspectedColumn.getActualColumnName();
        }

        if (primaryKeyColumn != null) {
            IntrospectedColumn introspectedColumn = introspectedTable.getColumn(primaryKeyColumn);
