...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    private boolean suppressDate = true; // 不打印注释 的时间
    private boolean suppressAllComments = false;
    private boolean suppressXMLComments = false;
    private boolean suppressClassComments = true;
    private boolean suppressEnumComments = true;
