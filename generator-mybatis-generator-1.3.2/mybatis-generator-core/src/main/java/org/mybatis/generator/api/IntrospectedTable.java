...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_INSERT_SELECTIVE_GET_KEY_STATEMENT_ID,
    ...
    protected void calculateXmlAttributes() {
        ...
        setInsertSelectiveGetKeyStatementId("insertSelectiveGetKey"); //$NON-NLS-1$
    ...
    public void setInsertSelectiveGetKeyStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_INSERT_SELECTIVE_GET_KEY_STATEMENT_ID, s);
    }
    ...
    public String getInsertSelectiveGetKeyStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_INSERT_SELECTIVE_GET_KEY_STATEMENT_ID);
    }
